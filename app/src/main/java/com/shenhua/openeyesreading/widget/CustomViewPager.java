...
/**
 * 自定义ViewPager使其具有阻尼弹性效果
 */
public class CustomViewPager extends ViewPager {

    private Rect mRect = new Rect();//用来记录初始位置
    private int pagerCount = 3;//viewpager页卡总数
    private int currentItem = 0;//当前页卡项
    private boolean handleDefault = true;//默认是手势
    private float preX = 0f;//用于记录起点
    private static final float RATIO = 0.5f;//摩擦系数
    private static final float SCROLL_WIDTH = 30f;//滑动宽度
